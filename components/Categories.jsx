...
const Categories = () => {
  const { projectByCategoryId , setProjectByCategoryId } = useContext(ProjectByCategoryIdContext);
      ...
      {interestCategories.map((item) => {
        return (
          <SwiperSlide key={item.id}>
            <div
              className="flex  flex-wrap bg-[#669640] gap-[4px] px-[16px] py-[14px] w-[78px] justify-center items-center h-[36px] rounded-[20px] categories"
